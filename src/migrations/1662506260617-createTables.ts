...
export class createTables1662506260617 implements MigrationInterface {
    name = 'createTables1662506260617'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "addresses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "country" character varying NOT NULL, "city" character varying NOT NULL, "state" character varying NOT NULL, "zipCode" character varying NOT NULL, "distict" character varying NOT NULL, CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_profile" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "sexualOrientatio" character varying NOT NULL, "gender" character varying NOT NULL, "bio" character varying NOT NULL, "height" numeric(2,2) NOT NULL, "education" character varying(28) NOT NULL, "profession" character varying(46) NOT NULL, "profileImage" character varying NOT NULL, "typeOfRelationshipId" uuid, "lookingForId" uuid, CONSTRAINT "REL_a3cf2b2cdb20377a60f316171d" UNIQUE ("typeOfRelationshipId"), CONSTRAINT "REL_e8ed974bd3abb351d9f6b2d78a" UNIQUE ("lookingForId"), CONSTRAINT "PK_f44d0cd18cfd80b0fed7806c3b7" PRIMARY KEY ("id"))`);
