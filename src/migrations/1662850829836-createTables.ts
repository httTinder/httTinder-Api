...
export class createTables1662850829836 implements MigrationInterface {
    name = 'createTables1662850829836'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_images" ADD CONSTRAINT "FK_42dc10ee00e99bb8bd02382892d" FOREIGN KEY ("userProfileId") REFERENCES "user_profile"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
